<template>
  <div class="size-full pt-14 flex items-center justify-center flex-col">
    <svg class="text-warning" xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24">
